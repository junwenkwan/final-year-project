...
class MetricNN(nn.Module):
    def __init__(self, args, emb_size):
        ...
        self.metric_network = args.metric_network # gnn_iclr_nl
        self.emb_size = emb_size # 64
        self.args = args
    ...
    def gnn_iclr_forward(self, z, zi_s, labels_yi):
        ...
        # nodes.shape: torch.Size([100, 6, 69])
