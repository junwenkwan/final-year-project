...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch_size_test', type=int, default=64, metavar='batch_size', help='Size of batch)')
    parser.add_argument('--iterations', type=int, default=50000, metavar='N', help='number of epochs to train ')
    ...
    parser.add_argument('--save_interval', type=int, default=300000, metavar='N', help='how many batches between each model saving')
    parser.add_argument('--test_interval', type=int, default=100, metavar='N', help='how many batches between each test')
    
    parser.add_argument('--test_N_way', type=int, default=5, metavar='N', help='Number of classes for doing each classification run')
    parser.add_argument('--train_N_way', type=int, default=5, metavar='N', help='Number of classes for doing each training comparison')
    ...
    parser.add_argument('--metric_network', type=str, default='gnn_iclr_nl', metavar='N', help='gnn_iclr_nl' + 'gnn_iclr_active')
